...
pub use models::{
    ...
    MIN_PERSONAL_TRAINING_CLASSES, MIN_PERSONAL_TRAINING_SAMPLES, PERSONAL_EMBEDDING_DIMENSION,
    RECOGNIZER_MODEL_SETTING, REFERENCE_BACKEND_SETTING, REFERENCE_MATCHING_SETTING,
    SIMILARITY_ARCHIVE_DIR_SETTING, SIMILARITY_FEATURE_VERSION,
